...
const Banner = () => {
  return (
      ...
      <div className="absolute md:pt-[21.5%] max-sm:pt-[33%] pl-[4%] flex flex-col lg:gap-8 md:gap-5 max-sm:gap-3">
        <Timer check={1}></Timer>
        <button className={`${button_style}`} >Buy now</button>
      </div>
      <h1><img src={two} alt="" className="max-sm:w-[100vh] max-sm:h-[28vh]" /></h1>
    </div>
  )
}

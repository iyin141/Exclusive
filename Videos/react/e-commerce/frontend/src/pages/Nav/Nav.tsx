...
const Nav = () => {
  return (
    <div className="w-[100%] border-b-1 border-[#B6B6B6]">
      ...
      <div className="flex justify-between pt-4 md:pl-[3rem] md:pr-[3rem] lg:pl-[5rem] lg:pr-[6rem] max-sm:pl-[2rem] max-sm:pr-[2rem] pb-4">
